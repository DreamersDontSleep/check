		...
		<el-tabs v-model="activeName" type="card" @tab-click="handleClick">
			<el-tab-pane label="录入数据" name="first">
				...
				<el-table :data="tableData" style="width: 100%">
					...
					<el-table-column label="报告类型">
						<template slot-scope="scope">
							<div v-if="scope.row.reportType == 1"><span style="color: rgba(107, 107, 107, 0.647058823529412);">房地产估价报告</span></div>
							<div v-if="scope.row.reportType == 2"><span style="color: #FFAA00;">土地估价报告</span></div>
							<div v-if="scope.row.reportType == 3"><span style="color: rgba(255, 0, 0, 0.647058823529412);">资产评估报告</span></div>
							<div v-if="scope.row.reportType == 4"><span style="color: rgba(255, 0, 0, 0.647058823529412);">预评估</span></div>
						</template>
					</el-table-column>
					...
					<el-table-column label="报告盖章状态">
						<template slot-scope="scope">
							<div v-if="scope.row.stampState == '' || scope.row.stampState == null || scope.row.stampState == 0"><span style="color: #999">未盖章</span></div>
							<div v-if="scope.row.stampState == 1"><span style="color: rgba(107, 107, 107, 0.647058823529412);">已转交待盖章</span></div>
							<div v-if="scope.row.stampState == 2"><span style="color: red">已盖章</span></div>
						</template>
					</el-table-column>
			...
			<el-tab-pane label="导入数据" name="second">
				...
				<el-table :data="tableData1" style="width: 100%">
					<el-table-column prop="projectName" label="报告编号" width="150"></el-table-column>
					<el-table-column prop="assessReportNum" label="项目名称" width="150"></el-table-column>
					<el-table-column prop="assessAim" label="估价目的" width="150"></el-table-column>
					<el-table-column prop="assessMethod" label="估价方法" width="150"></el-table-column>
					<el-table-column prop="assessStartTime" label="估价作业开始日" width="150"></el-table-column>
					<el-table-column prop="assessEndTime" label="估价作业结束日" width="150"></el-table-column>
					<el-table-column prop="valueTime" label="估价时点" width="150"></el-table-column>
					<el-table-column prop="floorArea" label="土地面积（㎡）" width="150"></el-table-column>
					<el-table-column prop="buildingArea" label="建筑面积（㎡）" width="150"></el-table-column>
					<el-table-column prop="assessTotalPrice" label="估价总值（万元）" width="150"></el-table-column>
					<el-table-column prop="assessUnitPrice" label="评估单价（元）" width="150"></el-table-column>
					<el-table-column prop="assessObject" label="估价对象位置" width="150"></el-table-column>
					<el-table-column prop="client" label="委托人" width="150"></el-table-column>
					<el-table-column prop="clientSite" label="委托人地址" width="150"></el-table-column>
					<el-table-column prop="clientPhone" label="委托人电话" width="150"></el-table-column>
					<el-table-column prop="firstReporter" label="第一报告人" width="150"></el-table-column>
					<el-table-column prop="firstReporterRgNum" label="第一报告人注册号" width="150"></el-table-column>
					<el-table-column prop="partReporter1" label="参与报告人1" width="150"></el-table-column>
					<el-table-column prop="partReporter1RgNum" label="注册号" width="150"></el-table-column>
					<el-table-column prop="partReporter2" label="参与报告人2" width="150"></el-table-column>
					<el-table-column prop="branchOffice" label="分公司" width="150"></el-table-column>
			...
			getExcelList(para).then(res => {
				...
				if (res.code == 200) {
					...
					require.ensure([], () => {
						...
						const tHeader = ['序号', '申请编号', '分公司', '评估目的', '报告类型', '申请人', '申请时间', '报告审批状态', '报告盖章状态', '备注'];
						const filterVal = [
							'projectName',
							'applicationNum',
							'branchOffice',
