  ...
  <div class="dormitory">
    ...
    <div class="dormitoryData">
      <el-table
        ...
        <el-table-column label="结构" prop="technicalLeader">
        </el-table-column>
        <el-table-column label="成新" prop="projectLeader">
        </el-table-column>
        <el-table-column label="成套" prop="constructionArea">
        </el-table-column>
				<el-table-column label="区位" prop="assessAmount">
				</el-table-column>
				<el-table-column label="层次" prop="assessAmount">
				</el-table-column>
				<el-table-column label="朝向" prop="assessAmount">
				</el-table-column>
